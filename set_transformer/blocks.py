...
class MAB(nn.Module):
    def __init__(self, d: int, h: int, rff: RFF) -> None:
        """
        Arguments:
...
class SAB(nn.Module):
    def __init__(self, d: int, h: int, rff: torch.Tensor) -> None:
        super().__init__()
...
class ISAB(nn.Module):
    def __init__(self, d: int, m: int, h: int, rff1: RFF, rff2: RFF) -> None:
        """
        Arguments:
            d: an integer, input dimension.
...
class PMA(nn.Module):
    def __init__(self, d: int, k: int, h: int, rff: RFF) -> None:
        """
        Arguments:
            d: an integer, input dimension.
